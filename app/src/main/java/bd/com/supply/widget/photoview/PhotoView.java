package bd.com.supply.widget.photoview;
...
//            onUp(e2);
    ...
    /**
     *
     * @return whether cross border
     */
    public boolean isCrossBorderHorizontal(){
        return mImgRect.left < 0 || mImgRect.right > mWidgetRect.width();
    }
}